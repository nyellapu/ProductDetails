sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("mckesson/eu/ProductDetails/app", ".html");
	...
	return Opa5.extend("mckesson.eu.ProductDetails.test.integration.arramgements.Arrangement", {

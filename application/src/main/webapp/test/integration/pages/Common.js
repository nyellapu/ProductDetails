sap.ui.define([
	...
	return Opa5.extend("mckesson.eu.ProductDetails.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["mckesson/eu/ProductDetails/localService/mockserver"], function (mockserver) {
